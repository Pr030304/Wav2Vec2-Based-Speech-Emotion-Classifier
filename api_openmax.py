...
from pred_openmax import inference_function, get_input
...
def predict():
    ...
    try:
        ...
        inps = get_input(temp_path, processor_new)
        label, prob_total, probabilities = inference_function(inps, model_new)
